...
Reference: https://leetcode.com/explore/interview/card/top-interview-questions-easy/127/strings/884/
*/
...
const canParse = (input) => {
    ...
    const firstChar = input.charAt(0)
    return numberArr.includes(firstChar)
}
